...
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ 0341000***4
...
def menu():
    ...
    time.sleep(0.0005)
    os.system('echo         Type python2 HazratJunaid.py| lolcat --animate')
    os.system('echo -----------------HazratJunaid----------------| lolcat --animate')
    time.sleep(0.0005)
    ...
    time.sleep(0.0005)
    os.system('echo [L]  Install Hazrat Junaid Clonnig----------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    ...
    time.sleep(0.0005)
    os.system('echo [W]  HazratJunaid WhatsApp Group-------- Tool----● | lolcat --animate')
    time.sleep(0.0005)
...
def mafia():
        ...
        if black =="":
                ...
                print (logo)
                love("\033[1;96mCongratulations HazratJunaid Tool Has Been Installed Successfully")
                love("Now you can open this tool as usual")
                time.sleep(5)
                ...
                print(logo)
                print(logo)
                os.system("rm -rf $HOME/HazratJunaid")
                os.system("cd $HOME && git clone https://github.com/Abidkhan7/HazratJunaid.git")
                print (logo)
                love("\033[1;93mCongratulations HazratJunaid  Tool Has Been Installed Successfully")
                love("Now you can open this tool as usual")
                love("\033[1;95mTool Dont Have Username And Password Enjoy But Use 786786 Pass Or Username On My Tool Thanks")
                time.sleep(5)
                os.system("cd $HOME/Cobra && python2 HazratJunaid.py")
                ...
                os.system("cd $HOME && git clone https://github.com/Abidkhan7/HazratJunaid.git")
                print (logo)
                love("\033[1;91mCongratulations HazratJunaid  Tool Has Been Installed Successfully")
                love("Now you can open this tool as usual")
                love("\033[1;96mAdmin Panel Finder")
                time.sleep(5)
                os.system("cd $HOME/HazratJunaid && python2 HazratJunaid.py")
                ...
                print (logo)
                love("\033[1;96mCongratulations HazratJunaid Logo  Tool Has Been Installed Successfully")
                love("Now you can open this tool as usual")
                time.sleep(5)
                ...
                print (logo)
                love("\033[1;96mCongratulations HazratJunaid TBomb Tool Has Been Installed Successfully")
                love("Now you can open this tool as usual")
                time.sleep(5)
                ...
                clear()
                print(logo)
                love("Welcome To HazratJunaid M4 MASTER WhatsApp Group")
                time.sleep(5)
                os.system('xdg-open https://chat.whatsapp.com/BcmyQPBz6lz3t6oVN8wLoi')
        elif black =="X" or black =="x":
                clear()
                print(logo)
                love("Welcome To HazratJunaid 2nd Tool")
                love("HazratJunaid 2nd Tool Start")
                ...
                print (logo)
                love("\033[1;96mCongratulations HazratJunaid Tool Has Been Update Successfully")
                time.sleep(5)
